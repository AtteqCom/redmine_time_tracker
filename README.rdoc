= Redmine Time Tracker plugin for Redmine >= 3.2
...
The newest version is always at {GitHub}[http://github.com/babky-atteq/redmine_time_tracker]. This is a fork from {GitHub}[http://github.com/martinllanos/redmine_time_tracker] which got outdated.
